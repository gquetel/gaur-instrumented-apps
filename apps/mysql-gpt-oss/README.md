...
This folder provides a Nix expression of a MySQL instrumented (by the GAUR tool) parser. This MySQL's implementation relies on semantic tags derived from the [documentation](https://dev.mysql.com/doc/refman/8.4/en/sql-statements.html) of MySQL. 
