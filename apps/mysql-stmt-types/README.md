...
This folder provides a Nix expression of a MySQL instrumented (by the GAUR tool) parser. This MySQL's implementation relies on expert-defined semantic tags. 
