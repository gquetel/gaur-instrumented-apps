...
| mysql-chatgpt | ADMINISTRATIVE, CLAUSE_COMPONENT, CONSTRAINT_DEFINITION, DATA_IMPORT_EXPORT, DATA_TYPE, DDL_STATEMENT, DML_STATEMENT, ENTRY_POINT, EXPRESSION, FUNCTION_CALL, IDENTIFIER, LITERAL_VALUE, OPTIONAL_MODIFIER, QUERY_STRUCTURE, REPLICATION_CLUSTER, STORED_PROCEDURE, SYNTAX_ELEMENT, TABLE_REFERENCE, TRANSACTION_CONTROL, USER_MANAGEMENT                                                           |
